...
<head>
    <meta charset="utf-8">
    <title> Lupa Password | SARPAS</title>
            ...
            <div class="container">
                ...
                <div class="account-box">
                    <div class="account-wrapper">
                        ...
                        @endif
                        <h4 class="text-center"><strong>LUPA KATA SANDI</strong></h4>
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form-group text-center custom-mt-form-group">
                                <button class="btn btn-primary btn-block account-btn" type="submit">Kirim</button>
                            </div>
