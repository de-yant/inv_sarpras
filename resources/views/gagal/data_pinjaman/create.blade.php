        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-body">
                            <form action="{{ route('datapinjaman-store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="tgl_peminjaman"
                                                    id="tgl_peminjaman" value="{{ $tgl_peminjaman }}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control"
                                                    ...
                                                    id="nama_peminjam" value="{{ old('nama_peminjam') }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control"
                                                    ...
                                                    id="no_tlp" value="{{ old('no_tlp') }}"
                                                    placeholder="082216280746">
                                                @error('no_tlp')
                                                    <div class="alert alert-danger mt-2">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-md-4 col-form-label">Batas Peminjaman</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="bts_pengembalian"
                                                    id="bts_pengembalian" value="{{ $bts_peminjaman }}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
