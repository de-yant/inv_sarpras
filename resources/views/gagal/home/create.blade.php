                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <ul class="breadcrumb float-right p-0 mb-0">
                                ...
                                <li class="breadcrumb-item">
                                    <span>{{ isset($title) ? $title : 'Title tidak diatur' }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control"
                                                            name="tgl_peminjaman" id="tgl_peminjaman"
                                                            value="{{ $tgl_peminjaman }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control"
                                                            @error('nama_peminjam') is-invalid @enderror
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-4 col-form-label">Batas Peminjaan</label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control"
                                                            name="bts_pengembalian" id="bts_pengembalian"
                                                            value="{{ $bts_pengembalian }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
