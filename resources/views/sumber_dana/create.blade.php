            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                    <ul class="breadcrumb float-right p-0 mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('sumberdana') }}">Sumber Dana</a></li>
                        ...
                        <div class="card-body">
                            <form action="{{ route('sumberdana-store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-md-2 col-form-label">Sumber Dana</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" @error('sumber_dana') is-invalid @enderror name="sumber_dana" id="sumber_dana" value="{{ old('sumber_dana') }}">
                                                @error('sumber_dana')
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="{{ url('sumberdana') }}" class="btn btn-secondary">Batal</a>
                                </div>
                            </form>
                        </div>
                    </div>
